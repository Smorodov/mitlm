/* lbfgs.f -- translated by f2c (version 20200916).
	 ...
	 doublereal *eps, doublereal *xtol, doublereal *w, integer *iflag)
{
    ...
    static char fmt_200[] = "(/\002 IFLAG= -1 \002,/\002 LINE SEARCH FAILED."
	    " SEE\002,\002 DOCUMENTATION OF ROUTINE MCSRCH\002,/\002 ERROR RE"
	    "TURN\002,\002 OF LINE SEARCH: INFO= \002,i2,/\002 POSSIBLE CAUSE"
	    "S: FUNCTION OR GRADIENT ARE INCORRECT\002,/\002 OR INCORRECT TOL"
	    "ERANCES\002)";
